...
tr:nth-child(even) {background-color: #bfa3a5;}
.topimg { height:110px; background-image: url("data/rank1.png"); }
.bottomimg { height:110px; background-image: url("data/rank2.png"); }
body { background-color: #c5a8aa; font-family: Arial, Helvetica, sans-serif; }
input[type="text"]{ background-color: #c5a8aa; padding: 10px 20px; line-height: 38px; font-size: 38px; font-family: Arial, Helvetica, sans-serif; color: #946366; }
</style>
</head>
<body>
